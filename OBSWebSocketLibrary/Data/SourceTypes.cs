...
namespace OBSWebSocketLibrary.Data
{
    ...
    public static class SourceTypeSettings
    {
        private static readonly Dictionary<SourceTypes, Type> sourceTypeSettingsDictionary = new Dictionary<SourceTypes, Type>()
        {
            ...
            { SourceTypes.mask_filter, typeof(Models.TypeDefs.FilterTypes.MaskFilter) },
            { SourceTypes.crop_filter, typeof(Models.TypeDefs.FilterTypes.CropFilter) },
            { SourceTypes.gain_filter, typeof(Models.TypeDefs.FilterTypes.GainFilter) },
            { SourceTypes.color_filter, typeof(Models.TypeDefs.FilterTypes.ColorFilter) },
            { SourceTypes.scale_filter, typeof(Models.TypeDefs.FilterTypes.ScaleFilter) },
            { SourceTypes.scroll_filter, typeof(Models.TypeDefs.FilterTypes.ScrollFilter) },
            { SourceTypes.gpu_delay, typeof(Models.TypeDefs.FilterTypes.GpuDelay) },
            { SourceTypes.color_key_filter, typeof(Models.TypeDefs.FilterTypes.ColorKeyFilter) },
            { SourceTypes.clut_filter, typeof(Models.TypeDefs.FilterTypes.ClutFilter) },
            { SourceTypes.sharpness_filter, typeof(Models.TypeDefs.FilterTypes.SharpnessFilter) },
            { SourceTypes.chroma_key_filter, typeof(Models.TypeDefs.FilterTypes.ChromaKeyFilter) },
            { SourceTypes.async_delay_filter, typeof(Models.TypeDefs.FilterTypes.AsyncDelayFilter) },
            { SourceTypes.noise_suppress_filter, typeof(Models.TypeDefs.FilterTypes.NoiseSupressFilter) },
            { SourceTypes.invert_polarity_filter, typeof(Models.TypeDefs.FilterTypes.InvertPolarityFilter) },
            { SourceTypes.noise_gate_filter, typeof(Models.TypeDefs.FilterTypes.NoiseGateFilter) },
            { SourceTypes.compressor_filter, typeof(Models.TypeDefs.FilterTypes.CompressorFilter) },
            { SourceTypes.limiter_filter, typeof(Models.TypeDefs.FilterTypes.LimiterFilter) },
            { SourceTypes.expander_filter, typeof(Models.TypeDefs.FilterTypes.ExpanderFilter) },
            { SourceTypes.luma_key_filter, typeof(Models.TypeDefs.FilterTypes.LumaKeyFilter) },
            ...
            { SourceTypes.vst_filter, typeof(Models.TypeDefs.FilterTypes.VstFilter) },
